...
function __autoload($classe){
    if( is_file(CLASS_DIR.$classe.".php") ){
        include_once(CLASS_DIR.$classe.".php");
    } else if( is_file(CLASS_DIR.$classe."".CLASS_FILE_SUFIX.".php") ){
        include_once(CLASS_DIR.$classe."".CLASS_FILE_SUFIX.".php");
    }
}
