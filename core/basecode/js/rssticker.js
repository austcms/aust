...
document.write('<div id="'+divId+'" class="'+divClass+'" >Carregando...</div>')
...
document.getElementById(this.tickerid).innerHTML="...<!-- <b>Erro</b> tentando ler RSS feed!<br /> -->"+this.ajaxobj.responseText
return
}
var instanceOfTicker=this
